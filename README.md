...
| Tested SWAT+ 62 update | 0.1.0.9013 | [Updated source](https://github.com/MR-Eini/SWATreadR-swat62/tree/swat62-v0.1.0.9013) |

**[Compare old and updated code](https://github.com/MR-Eini/SWATreadR-swat62/compare/before-swat62-update...swat62-v0.1.0.9013?w=1)** - GitHub highlights removed lines in red and added lines in green. Whitespace-only differences are hidden in this link; [show the complete diff](https://github.com/MR-Eini/SWATreadR-swat62/compare/before-swat62-update...swat62-v0.1.0.9013) if needed.
